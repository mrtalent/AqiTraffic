...
namespace GenerateCasesCW
{
    ...
    class Program
    {
        ...
        static void GenerateCases(string speedDir)
        {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                rsmap.Initial(@"D:\Users\v-tianhe\aqiTraffic\Data\RoadStationMapCW");

                GenerateCases(@"D:\Users\v-tianhe\aqiTraffic\Data\TrafficEsti\");
            }
            else
            {
                rsmap.Initial(args[1]);
                GenerateCases(args[0]);
            }
            cache.Close();
            return;
        }
